...
export const REFERENCES = [
  {
    id: "ref-canva",
    label: "Official Canva Design Pack",
    description:
  ...
  },
  {
    ...
    label: "seniorscb.com",
    description:
      "Structural and layout inspiration for the SE-10 portal — the seniors' class portal that informed the multi-page design approach.",
  ...
  {
    id: "ref-hero",
    label: "AI-Generated Hero Visual",
    description:
      "The circuit-board hero graphic on the home screen was generated using Base44's AI image generation tool and is not an official school asset.",
    url: null,
    type: "ai",
